...
public final class XmlSaxNodeReader implements IXmlParser {
    ...
    private FileSource mResources;
    private XmlReadNode mCurrentNode = new XmlReadNode();
    private SaxNodeManager mSaxNodeParser;

    public XmlSaxNodeReader(FileSource resources , SaxNodeManager saxNodeManager) {
    ...
    private void parserInner() {
        ...
        LogUtils.d(true,TAG, "parser start: ", timeMills);
        ...
        try {
            ...
            LogUtils.d(true,TAG, "parser end: ", (System.currentTimeMillis() - timeMills));
        }
    }
