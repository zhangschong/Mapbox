...
/* package */ class KmlContainerParser {
    ...
    private static KmlContainer assignPropertiesToContainer(XmlPullParser parser)
        ...
        ArrayList<Feature> containerPlacemarks = new ArrayList<>();
        ArrayList<KmlContainer> nestedContainers = new ArrayList<KmlContainer>();
        HashMap<String, HashMap<String, String>> containerStyleMaps = new HashMap();
        ArrayList<KmlGroundOverlay> containerGroundOverlays
                = new ArrayList<KmlGroundOverlay>();
            ...
            if (eventType == START_TAG) {
                if (parser.getName().matches(UNSUPPORTED_REGEX)) {
                    ...
                    containerGroundOverlays
                            .add(KmlFeatureParser.createGroundOverlay(parser));
                }
            }
    ...
    private static void setContainerStyleMap(XmlPullParser parser,
                                             HashMap<String, HashMap<String, String>> containerStyleMap) throws XmlPullParserException, IOException {
    ...
    private static void setContainerPlacemark(XmlPullParser parser,
                                              ArrayList<Feature> containerPlacemarks)
            throws XmlPullParserException, IOException {
        containerPlacemarks.add(KmlFeatureParser.createPlacemark(parser));
    }
