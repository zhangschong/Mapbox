...
public class KmlContainer {
    ...
    /*package*/ KmlContainer(HashMap<String, String> properties, HashMap<String, KmlStyle> styles,
                             ArrayList<Feature> placemarks, HashMap<String, HashMap<String, String>> styleMaps,
                             ArrayList<KmlContainer> containers, ArrayList<KmlGroundOverlay> groundOverlay, String Id) {
     ...
     */
    /* package */ HashMap<String, HashMap<String, String>> getStyleMap() {
        return mStyleMap;
    }
     ...
     */
    /* package */ ArrayList<KmlGroundOverlay> getGroundOverlayHashMap() {
     ...
     */
    /*package*/ ArrayList<Feature> getPlacemarksHashMap() {
        return mPlacemarks;
    }
