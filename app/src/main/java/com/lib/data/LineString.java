 ...
 * {@link com.lib.data.kml.KmlLineString KmlLineString} and
 * {@link com.google.maps.android.data.geojson.GeoJsonLineString GeoJsonLineString}
 */
public class LineString implements Geometry<List<KMLLatLng>> {

    private static final String GEOMETRY_TYPE = "LineString";

    private final List<KMLLatLng> mCoordinates;
     ...
     */
    public LineString(List<KMLLatLng> coordinates) {
        if (coordinates == null) {
     ...
     */
    public List<KMLLatLng> getGeometryObject() {
        return mCoordinates;
    }
