 ...
 * {@link com.lib.data.kml.KmlPolygon KmlPolygon}
 */
public interface DataPolygon extends Geometry {
     ...
     */
    List<KMLLatLng> getOuterBoundaryCoordinates();
     ...
     */
    List<List<KMLLatLng>> getInnerBoundaryCoordinates();
